...
export default function BookStarFill({ ...props }: SVGProps<SVGSVGElement>) {
  return (
    <svg fill="none" viewBox="0 0 24 24" {...props}>
      <path
        fill="currentColor"
        d="M11.6 9.527a.68.68 0 0 1-.51.371l-1.454.212 1.052 1.025a.68.68 0 0 1 .195.6l-.249 1.448 1.3-.684a.68.68 0 0 1 .632 0l1.3.684-.249-1.448a.68.68 0 0 1 .195-.6l1.052-1.025-1.453-.212a.68.68 0 0 1-.51-.37L12.25 8.21z"
      />
      <path
        fill="currentColor"
