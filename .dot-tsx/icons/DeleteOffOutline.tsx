...
export default function DeleteOffOutline({
  ...props
  ...
  return (
    <svg fill="none" viewBox="0 0 24 24" {...props}>
      ...
      <path
        fill="currentColor"
        d="m18.197 6.5-.762 7.753 1.372 1.372.897-9.125h.796l.102-.007A.75.75 0 0 0 20.5 5h-5.25l-.005-.184A3.25 3.25 0 0 0 8.75 5h-.568l1.5 1.5zM12 3.25c.966 0 1.75.784 1.75 1.75h-3.5l.006-.144A1.75 1.75 0 0 1 12 3.25"
      />
    </svg>
  );
}
