...
export default function DesktopArrowRightFill({
  ...props
  ...
  return (
    <svg fill="none" viewBox="0 0 24 24" {...props}>
      <path
        fill="currentColor"
        d="M23 6.5a5.5 5.5 0 1 1-11 0 5.5 5.5 0 0 1 11 0M14.5 6a.5.5 0 0 0 0 1h4.793l-1.647 1.646a.5.5 0 0 0 .708.708l2.5-2.5a.5.5 0 0 0 0-.708l-2.5-2.5a.5.5 0 0 0-.708.708L19.293 6z"
      />
      <path
        fill="currentColor"
