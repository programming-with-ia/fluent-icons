...
export default function TableDeleteRowOutline({
  ...props
  ...
  return (
    <svg fill="none" viewBox="0 0 24 24" {...props}>
      ...
      <path
        fill="currentColor"
        d="M8.727 12.75q.035-.039.072-.076L9.473 12l-.674-.674-.072-.076H2.75a.75.75 0 0 0 0 1.5zm6.796 0h5.727a.75.75 0 0 0 0-1.5h-5.727l-.072.076-.674.674.674.674z"
      />
    </svg>
  );
}
