...
export default function VehicleBusOutline({
  ...props
  ...
  return (
    <svg fill="none" viewBox="0 0 24 24" {...props}>
      <path
        fill="currentColor"
        d="M8 16a1 1 0 1 0 0-2 1 1 0 0 0 0 2m9-1a1 1 0 1 1-2 0 1 1 0 0 1 2 0M10.75 5a.75.75 0 0 0 0 1.5h2.5a.75.75 0 0 0 0-1.5z"
      />
      <path
        fill="currentColor"
