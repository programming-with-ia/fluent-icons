...
export default function TextSuperscriptFill({
  ...props
  ...
  return (
    <svg fill="none" viewBox="0 0 24 24" {...props}>
      ...
      <path
        fill="currentColor"
        d="m11.317 12 4.4-5.133q.201-.295.425-.537a2 2 0 0 1-1.14-1.703L10 10.463 4.76 4.35a1 1 0 1 0-1.52 1.302L8.684 12l-5.442 6.35a1 1 0 0 0 1.518 1.3L10 13.538l5.24 6.114a1 1 0 0 0 1.52-1.302z"
      />
    </svg>
  );
}
