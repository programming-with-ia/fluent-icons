...
export default function MicProhibitedOutline({
  ...props
  ...
  return (
    <svg fill="none" viewBox="0 0 24 24" {...props}>
      <path
        fill="currentColor"
        d="M15 6v5.498a6.5 6.5 0 0 0-1.532.903q.032-.195.032-.401V6a2.5 2.5 0 0 0-5 0v6a2.5 2.5 0 0 0 3.303 2.368 6.5 6.5 0 0 0-.628 1.628A4 4 0 0 1 7 12V6a4 4 0 1 1 8 0"
      />
      <path
        fill="currentColor"
