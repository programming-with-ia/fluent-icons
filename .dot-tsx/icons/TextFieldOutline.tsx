...
export default function TextFieldOutline({
  ...
  return (
    <svg fill="none" viewBox="0 0 24 24" {...props}>
      <path
        fill="currentColor"
        d="M15 8.5h-2.25v7h.5a.75.75 0 0 1 0 1.5h-2.5a.75.75 0 0 1 0-1.5h.5v-7H9v.75a.75.75 0 1 1-1.5 0v-1.5A.75.75 0 0 1 8.25 7h7.5a.75.75 0 0 1 .75.75v1.5a.75.75 0 0 1-1.5 0z"
      />
      <path
        fill="currentColor"
