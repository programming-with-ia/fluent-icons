...
export default function TableDeleteColumnOutline({
  ...props
  ...
  return (
    <svg fill="none" viewBox="0 0 24 24" {...props}>
      ...
      <path
        fill="currentColor"
        d="M11.25 8.727q.039.035.076.072l.674.674.674-.674q.037-.038.076-.072V2.75a.75.75 0 0 0-1.5 0zm0 6.796v5.727a.75.75 0 0 0 1.5 0v-5.727l-.076-.072-.674-.674-.674.674z"
      />
    </svg>
  );
}
